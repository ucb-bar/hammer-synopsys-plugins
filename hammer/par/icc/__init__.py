...
HammerTechnologyUtils.to_plain_item))
    ...
    def floorplan_design(self) -> bool:
        ...
        if floorplan_mode == "annotations":
            ...
            self.write_contents_to_path("\n".join(self.generate_floorplan_tcl()), floorplan_tcl)
        elif floorplan_mode == "default":
            default_fp = "create_floorplan -control_type aspect_ratio -core_aspect_ratio 1 -core_utilization 0.7 -left_io2core 0 -bottom_io2core 0 -right_io2core 0 -top_io2core 0 -start_first_row"
            self.write_contents_to_path(default_fp, floorplan_tcl)
        else:
    ...
    def place_bumps(self) -> bool:
        ...
        if bumps_mode == "manual":
            ...
            if bumps is not None:
                ...
                self.write_contents_to_path("\n".join(self.generate_bumps_tcl()), place_bumps_tcl)
        ...
        if pin_mode == "none":
            ...
            if (pin_generation_mode == "full_auto" or pin_generation_mode == "semi_auto"):
                ...
                if pins is not None:
                    ...
                    self.write_contents_to_path("\n".join(self.generate_pins_tcl()), place_pins_tcl)
    ...
    def run_icc(self) -> bool:
        ...
        open_mw_cel -readonly latest
                """.format(run_dir=self.run_dir, top=self.top_module), self.open_chip_tcl)
